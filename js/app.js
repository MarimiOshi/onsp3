...
const App = {
    ...
    init: function() {
        ...
        console.log("ONSP App Initializing (Layout/Nav/Modal Fix)...");
        ...
        this.elements.tabNavigation = this.DOMUtils.qs('#tabNavigation'); // ★ HTMLのグローバルタブナビのIDを参照
        ...
        if (this.UIComponents && this.modules.shikoshiko) {
            console.log("Setting up shikoshiko settings modal via App.js...");
            ...
            console.error("UIComponents or ShikoshikoModule not available for modal setup in App.js.");
        }

        this.addEventListeners();
        this.switchToTab(this.state.activeTab);
        console.log("ONSP App Initialized Successfully (Layout/Nav/Modal Fix).");
    },

    logDependencyError: function(dependencyName) { /* 変更なし */
        console.error(`${dependencyName} not loaded or defined! App might not work correctly.`); return null;
    },
    addEventListeners: function() { /* 変更なし */
    ...
    switchToTab: function(targetId) { /* 変更なし */
    ...
    getModuleNameFromId: function(tabId) { /* 変更なし */
    ...
    applyTheme: function(hexColor) { /* 変更なし */
    ...
    notifyWeakPointChange: function(relativePath, isNowWeak) { /* 変更なし */
